...
def categorize_dish(dish_name, dish_ingredients):
    ...
    for name, ingredient_set in categories.items():
        
        if dish_ingredients <= ingredient_set:
...
def tag_special_ingredients(dish):
    ...
    flagged_ingredients = set(ingredients).intersection(SPECIAL_INGREDIENTS)
    
    return (dish_name, flagged_ingredients)
